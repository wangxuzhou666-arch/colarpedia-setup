...
const wangXue = {
  ...
  data: {
    ...
    tagline_zh: "宾大系统工程硕士在读 · 关注机器学习系统与开发者体验",
    ...
    shipped: [
      {
        ...
        outputs: [
          {
            label: "v0.4 release notes",
            url: "https://github.com/wangxue-demo/quanta-cli/releases/tag/v0.4",
          },
          {
            label: "Polars vs pandas: memory predictability in backtesting",
            url: "https://wangxue-demo.github.io/posts/polars-memory.html",
          },
        ],
